                                ...
                                <div class="form-validation">
                                    <?php echo form_open('User_C/update');?>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="name" value="<?php print_r($result[0]->firstname);?>"placeholder="Enter a First Name..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Last Name <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="sirname" value="<?php print_r($result[0]->lastname);?>"placeholder="Enter a Last Name..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Email <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="val-email" value="<?php print_r($result[0]->email);?>"placeholder="Your valid email..">
                                            </div>
                                        </div>
                                       <!-- <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-number" name="val-number"value="<?php print_r($result[0]->mobile);?>" placeholder="97029 *****">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="plan">
                                                    <option value="<?php print_r($result[0]->mobile);?>"><?php print_r($result[0]->mobile);?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" value="<?php print_r($result[0]->address);?>" name="address" placeholder="Street Name , Building Name, Pin no ">
                                            </div>
                                        </div>
