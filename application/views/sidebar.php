            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="<?php echo base_url('User_C/dashboard');?>" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Home <!--<span class="label label-rouded label-primary pull-right">2</span>--></span></a>
                       ...
                       <!-- <li class="nav-label">Apps</li>-->
                        ...
                        <li> <a class="has-arrow  " href="<?php echo base_url('Plan_C/select');?>" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Select Plan</span></a>
                            
                        </li>
                         <li> <a class="has-arrow  " href="<?php echo base_url('User_C/plan');?>" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Subscribe Plan</span></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <!-- <li class="nav-label">Apps</li>-->
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">plan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('Plan_C/index');?>">Creat Plan</a></li>
                                <li><a href="<?php echo base_url('Plan_C/dashboard');?>">View Plan </a></li>
                        ...
                        <li> <a class="has-arrow  " href="<?php echo base_url('Admin_C/do_upload');?>" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Creat Domian</span></a>
