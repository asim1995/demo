<body class="fix-header fix-sidebar">
    ...
    <!-- Main wrapper  -->
    <div id="main-wrapper"> <!-- header header  -->
        <div class="header">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="<?php echo base_url('User_C/profile');?>"><i class="ti-user"></i> Profile</a></li>
                                    <li><a href="<?php echo base_url('User_C/update');?>"><i class="ti-pencil"></i> Edit Account</a></li>
                                <!--    <li><a href="#"><i class="ti-email"></i> Inbox</a></li>-->
                                    <li><a href="<?php echo base_url('Index_C/change');?>"><i class="ti-control-shuffle"></i> change password</a></li>
                                   <!-- <li><a href="#"><i class="ti-wallet"></i> Balance</a></li>-->
                                    <li><a href="<?php echo base_url('Index_C/logout');?>"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
