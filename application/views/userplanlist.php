                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody><?php  foreach($result as $value): ?>
                                            <tr>
                                              ...
                                              <!--  <td><a href="<?php echo base_url('Insta_C/')."?id=".$value->uuid;?>"  ><button type="submit" name="submit" class="btn btn-success">Buy Now</button></a></td>
                                                
                                                <td><a href="<?php echo base_url('Plan_C/update')."?id=".$value->uuid;?>"  ><button type="submit" class="btn btn-primary">EDIT</button></a>
                                                    <a href="<?php echo base_url('Plan_C/delete')."?id=".$value->uuid;?>"  ><button type="submit"  class="btn btn-danger">DELETE</button></a>
                                                    </td>-->
